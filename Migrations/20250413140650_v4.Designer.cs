...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FosoolSchool.Models.Lesson.Lesson", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FosoolSchool.Models.Lesson.LessonResource", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FosoolSchool.Models.Lesson.TeacherLessonResourceView", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("TeacherLessonResourceViews");
                });
            ...
            modelBuilder.Entity("FosoolSchool.Models.TeacherEntities.TeacherGradeSubject", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FosoolSchool.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "55f85ab4-5473-4cab-b0f5-7fe6efc54e4d",
                            CreatedAt = new DateTime(2025, 4, 13, 14, 6, 47, 156, DateTimeKind.Utc).AddTicks(8131),
                            CreatedUserId = "null",
                            IsDeleted = false,
                            Password = "AQAAALDzk2IeAfQWn6Qn8lyhN4aRyfBrw5v34ev473NIjBBwkwTf+FuzYbuJMje5nemQcw==",
                            UpdatedAt = new DateTime(2025, 4, 13, 14, 6, 47, 156, DateTimeKind.Utc).AddTicks(8133),
                            UpdatedUserId = "null",
            ...
            modelBuilder.Entity("FosoolSchool.Models.Lesson.LessonResource", b =>
                {
                    b.HasOne("FosoolSchool.Models.Lesson.Lesson", "Lesson")
                        .WithMany()
                        .HasForeignKey("LessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FosoolSchool.Models.User", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FosoolSchool.Models.Lesson.TeacherLessonResourceView", b =>
                {
                    b.HasOne("FosoolSchool.Models.Lesson.LessonResource", "Resource")
                        .WithMany()
            ...
            modelBuilder.Entity("FosoolSchool.Models.TeacherEntities.TeacherGradeSubject", b =>
                {
                    ...
                    b.HasOne("FosoolSchool.Models.TeacherEntities.TeacherTerm", null)
                        .WithMany("TeacherSubjects")
