...
namespace FosoolSchool.Controllers
{
    ...
    {
        private readonly IAcademicTermService _service;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public AcademicTermController(IAcademicTermService service, IHttpContextAccessor httpContextAccessor)
        {
            _service = service;
        ...
        public async Task<IActionResult> GetById([FromRoute] string id)
        {
            ...
            if (result == null)
            {
                return NotFound(new ResponseDTO { IsValid = false, Error = "Academic term not found" });
            }
            return Ok(new ResponseDTO
            {
                IsValid = true,
        ...
        [HttpPost("create")]
        public async Task<IActionResult> Create([FromBody] CreateAcademicTermDTO dto)
        {
        ...
        [HttpPost("update/{id}")]
        public async Task<IActionResult> Update([FromRoute] string id, [FromBody] UpdateGetAcademicTermDTO dto)
        {
            var userId = GetUserIdFromToken();
